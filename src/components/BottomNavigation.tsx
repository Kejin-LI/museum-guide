...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 w-full h-16 bg-white border-t border-stone-200 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-[900] ${isGuidePage ? 'hidden' : ''}`}>
      <div className="w-full max-w-3xl mx-auto h-full flex justify-around items-center px-2 relative">
